...
- **Frameworks & Libraries:** Pandas, NumPy, Matplotlib, Seaborn, Plotly, Scikit-learn, TensorFlow, Keras, Transformers, LangChain, Microsoft AutoGen,LangGraph(building multi agents system)
